...
Note: the email line for faculty cards is slightly different, so may not work for faculty cards. It's okay, though, because this script mainly intended for one-time use for migrating current HTML design to json design.
